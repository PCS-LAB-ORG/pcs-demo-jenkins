...
resource "aws_s3_bucket" "log_bucket" {
  ...
  tags = {
    Scannnedby = ""
    yor_trace  = "8bb6a3f8-af75-4f8c-abec-9627311704e7"
  }
}
resource "aws_s3_bucket" "foo" {
  ...
  tags = {
    Scannnedby = ""
    yor_trace  = "a77be0bd-b372-4325-9fb9-d0ace1f3ba99"
  }
}
...
resource "aws_cloudtrail" "foo_cloudtrail" {
  ...
  tags = {
    Scannnedby = ""
    yor_trace  = "f44711e0-59a3-47b8-94fd-3632f22188f0"
  }
}
...
resource "aws_vpc_peering_connection" "foo" {
  ...
  tags = {
    Scannnedby = ""
    yor_trace  = "a93b0d58-3b24-444a-a9e7-bc1c7899e878"
  }
}
resource "aws_vpc" "foo_vpc" {
  ...
  tags = {
    ...
    Scannnedby = ""
    yor_trace  = "fb2934a7-008e-446b-b514-9cbf211313f1"
  }
}
resource "aws_vpc" "bar_vpc" {
  ...
  tags = {
    ...
    Scannnedby = "Prisma"
    yor_trace  = "265a2932-d318-4ee0-b19a-d44d8af5ad17"
  }
}
...
resource "aws_security_group" "allow_tcp" {
  ...
  tags = {
    Scannnedby = ""
    yor_trace  = "0385d9c7-65a6-4daa-ac41-e6f0f5769eb4"
  }
}
...
resource "aws_security_group" "allow_rdp" {
  ...
  tags = {
    Scannnedby = ""
    yor_trace  = "f1f8765f-9b18-4506-8430-1f1e482cedea"
  }
}
...
resource "aws_security_group" "allow_all_traffic" {
  ...
  tags = {
    Scannnedby = ""
    yor_trace  = "772a4817-cde3-47a1-b95f-ea01a9596c99"
  }
}
...
resource "aws_security_group" "allow_udp69" {
  ...
  tags = {
    Scannnedby = ""
    yor_trace  = "321db733-3980-4baf-904c-f3b8e97f2aca"
  }
}
...
resource "aws_network_acl" "main" {
  ...
  tags = {
    Scannnedby = ""
    yor_trace  = "167ac46b-18a1-40b3-995b-f077b5f01207"
  }
}
...
resource "aws_redshift_parameter_group" "bar" {
  ...
  tags = {
    Scannnedby = ""
    yor_trace  = "c50d642f-1c91-4b89-addd-44ce2a75bc92"
  }
}
...
resource "aws_db_instance" "default" {
  ...
  tags = {
    Scannnedby = ""
    yor_trace  = "4bcee108-f309-471c-814e-5deb0b6ecd49"
  }
}
...
resource "aws_sns_topic" "default" {
  ...
  tags = {
    Scannnedby = ""
    yor_trace  = "070581ca-7246-45c1-9c19-ad94acfc0be6"
  }
}
resource "aws_db_event_subscription" "default" {
  ...
  tags = {
    Scannnedby = ""
    yor_trace  = "a43a240d-f570-4feb-9da2-a61a0a76ceb1"
  }
}
...
resource "aws_kms_key" "a" {
  ...
  tags = {
    Scannnedby = ""
    yor_trace  = "751900e5-56c1-4d48-93b5-e3163e0b4e9d"
  }
}
...
resource "aws_vpc" "mainvpc" {
  ...
  tags = {
    Scannnedby = ""
    yor_trace  = "a7296cff-6426-4640-8a29-47e002811e72"
  }
}
resource "aws_default_security_group" "default" {
  ...
  tags = {
    Scannnedby = ""
    yor_trace  = "665bc59c-890c-4823-a18a-fdcd39ce5553"
  }
}
...
resource "aws_ecs_task_definition" "github-backup" {
  ...
  tags = {
    Scannnedby = ""
    yor_trace  = "89c9b7bc-2f65-4f04-aebc-10c00c87f5ad"
  }
}
resource "aws_ecs_task_definition" "github-backup2" {
  ...
  tags = {
    Scannnedby = ""
    yor_trace  = "d82373ed-9386-40c1-8e96-a2c13ff7797a"
  }
}
...
resource "aws_elasticsearch_domain" "example" {
  ...
  tags = {
    Scannnedby = ""
    yor_trace  = "58fb1c8a-eb52-4dde-af11-e9c8c612513d"
  }
}
...
resource "aws_eks_cluster" "example" {
  ...
  tags = {
    Scannnedby = ""
    yor_trace  = "4a05bfb9-b907-46fc-9ee6-8942803cddf1"
  }
}