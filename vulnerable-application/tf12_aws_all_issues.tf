...
resource "aws_s3_bucket" "log_bucket" {
  ...
  tags = {
    yor_trace = "f86893e7-2f22-46f5-9e43-a76c31cd25f9"
  }
}
resource "aws_s3_bucket" "foo" {
  ...
  tags = {
    yor_trace = "d8d78859-11c3-488f-8c84-ba7cd0dda306"
  }
}
...
resource "aws_cloudtrail" "foo_cloudtrail" {
  ...
  tags = {
    yor_trace = "75bb281f-7f34-4611-9323-ae6d0a98222b"
  }
}
...
resource "aws_vpc_peering_connection" "foo" {
  ...
  tags = {
    yor_trace = "1ad26ade-55ef-4bae-bdca-9cb6fb1efc90"
  }
}
resource "aws_vpc" "foo_vpc" {
  ...
  tags = {
    ...
    yor_trace = "51db4f57-7a11-4cfc-a1a4-abb1b517a9b2"
  }
}
resource "aws_vpc" "bar_vpc" {
  ...
  tags = {
    ...
    yor_trace = "5f33128d-62f0-478d-b663-b48fb7e0b926"
  }
}
...
resource "aws_security_group" "allow_tcp" {
  ...
  tags = {
    yor_trace = "de4920d9-415c-4ad9-932d-e2a03647e075"
  }
}
...
resource "aws_security_group" "allow_rdp" {
  ...
  tags = {
    yor_trace = "cc9a119d-c88e-45e2-aa7d-e0854a75749f"
  }
}
...
resource "aws_security_group" "allow_all_traffic" {
  ...
  tags = {
    yor_trace = "4ab2b027-6202-4776-8c52-c03a2ccf8e93"
  }
}
...
resource "aws_security_group" "allow_udp69" {
  ...
  tags = {
    yor_trace = "f2d43550-296b-4ba2-8b1b-3391b7a953ce"
  }
}
...
resource "aws_network_acl" "main" {
  ...
  tags = {
    yor_trace = "9db5c7f2-ddfa-41f4-91d3-578cfb8d4aca"
  }
}
...
resource "aws_redshift_parameter_group" "bar" {
  ...
  tags = {
    yor_trace = "72a5d606-8817-403e-b9ab-394d6baa1d2c"
  }
}
...
resource "aws_db_instance" "default" {
  ...
  tags = {
    yor_trace = "c40890b7-d89c-477c-a798-69a778fea013"
  }
}
...
resource "aws_sns_topic" "default" {
  name = "rds-events"
  tags = {
    yor_trace = "e3c6c5e1-835a-42c6-b4be-e5664f0e0169"
  }
}
resource "aws_db_event_subscription" "default" {
  ...
  enabled = false
  tags = {
    yor_trace = "3198c889-335d-47d6-905d-7aaf6ebd1a09"
  }
}
...
resource "aws_kms_key" "a" {
  ...
  tags = {
    yor_trace = "f4e65c2f-f3fa-42da-8a4b-4fd9469589df"
  }
}
...
resource "aws_vpc" "mainvpc" {
  ...
  tags = {
    yor_trace = "e5215617-2a83-4131-82d5-ee2545430c8b"
  }
}
resource "aws_default_security_group" "default" {
  ...
  tags = {
    yor_trace = "4302192e-fef2-4874-bc65-c2a29af5da3c"
  }
}
...
resource "aws_ecs_task_definition" "github-backup" {
  ...
  DEFINITION
  tags = {
    yor_trace = "c129f714-9a98-4a24-9df7-cebfae6f6a6e"
  }
}
resource "aws_ecs_task_definition" "github-backup2" {
  ...
  DEFINITION
  tags = {
    yor_trace = "ea40901b-4dac-4dc4-8379-83ffb3caa02f"
  }
}
...
resource "aws_elasticsearch_domain" "example" {
  ...
  tags = {
    yor_trace = "cc2dcfcb-d841-4f44-8daa-8ebf19b4daaf"
  }
}
...
resource "aws_eks_cluster" "example" {
  ...
  version = "1.9.9"
  tags = {
    yor_trace = "51c5e124-8817-4a60-83e4-9513221d7ed5"
  }
}