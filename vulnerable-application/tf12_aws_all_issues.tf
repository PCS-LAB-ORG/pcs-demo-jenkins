...
resource "aws_s3_bucket" "log_bucket" {
  ...
  tags = {
    yor_trace = "34ad04b4-944c-40a4-b408-080cb51363c9"
  }
}
resource "aws_s3_bucket" "foo" {
  ...
  tags = {
    yor_trace = "fa1dfd8b-7dbe-4451-bed0-446e904abfa1"
  }
}
...
resource "aws_cloudtrail" "foo_cloudtrail" {
  ...
  tags = {
    yor_trace = "70ada4b2-be9f-485e-ba98-85d179d0256b"
  }
}
...
resource "aws_vpc_peering_connection" "foo" {
  ...
  tags = {
    yor_trace = "e3267bce-439e-4cee-9474-7489988c4da3"
  }
}
resource "aws_vpc" "foo_vpc" {
  ...
  tags = {
    ...
    yor_trace = "9ebf1193-d6d8-43e8-a33b-a236dbdb6464"
  }
}
resource "aws_vpc" "bar_vpc" {
  ...
  tags = {
    ...
    yor_trace = "55eb4949-4f1a-4b26-a635-8f5c72abffd6"
  }
}
...
resource "aws_security_group" "allow_tcp" {
  ...
  tags = {
    yor_trace = "c0c9e52e-dd35-4915-842f-a749abb4950d"
  }
}
...
resource "aws_security_group" "allow_rdp" {
  ...
  tags = {
    yor_trace = "9a43a3b1-30a6-4338-a989-b0178e026259"
  }
}
...
resource "aws_security_group" "allow_all_traffic" {
  ...
  tags = {
    yor_trace = "8f7fc5b9-c388-4c7b-a4ca-d3a047a269d8"
  }
}
...
resource "aws_security_group" "allow_udp69" {
  ...
  tags = {
    yor_trace = "f7efc05e-c431-499c-bf89-4daf0b549180"
  }
}
...
resource "aws_network_acl" "main" {
  ...
  tags = {
    yor_trace = "25f3b88c-dbab-4099-958a-03e962a5fa50"
  }
}
...
resource "aws_redshift_parameter_group" "bar" {
  ...
  tags = {
    yor_trace = "7e945739-62a9-4a5c-8129-6c8fe66ddb17"
  }
}
...
resource "aws_db_instance" "default" {
  ...
  tags = {
    yor_trace = "c4707741-074f-4c00-adfc-ed0cb6bfdf5e"
  }
}
...
resource "aws_sns_topic" "default" {
  name = "rds-events"
  tags = {
    yor_trace = "4c28351c-bef5-41bb-906d-250af85ab610"
  }
}
resource "aws_db_event_subscription" "default" {
  ...
  enabled = false
  tags = {
    yor_trace = "498bdec2-7216-48b9-93f5-a5a1849b58c9"
  }
}
...
resource "aws_kms_key" "a" {
  ...
  tags = {
    yor_trace = "ce72c142-d3cb-4512-bc8f-500fe36110b3"
  }
}
...
resource "aws_vpc" "mainvpc" {
  ...
  tags = {
    yor_trace = "74e65c4f-d483-44fd-a0e8-d79dac6932b9"
  }
}
resource "aws_default_security_group" "default" {
  ...
  tags = {
    yor_trace = "0a1a390e-3517-4821-b674-cf9b18f1c5ee"
  }
}
...
resource "aws_ecs_task_definition" "github-backup" {
  ...
  DEFINITION
  tags = {
    yor_trace = "dcd0b978-d3c7-4cbb-8783-8ca796d9fb90"
  }
}
resource "aws_ecs_task_definition" "github-backup2" {
  ...
  DEFINITION
  tags = {
    yor_trace = "75fed164-7d15-4854-a49e-32c91d2e613c"
  }
}
...
resource "aws_elasticsearch_domain" "example" {
  ...
  tags = {
    yor_trace = "d4a46cfa-f6f2-44d4-aa18-bdd1dd95c489"
  }
}
...
resource "aws_eks_cluster" "example" {
  ...
  version = "1.9.9"
  tags = {
    yor_trace = "c1f859a8-f8ae-4e71-866d-c6cef868a375"
  }
}