...
resource "aws_s3_bucket" "log_bucket" {
  ...
  tags = {
    yor_trace = "8adae136-be0f-4f32-ad7b-bcc1a6145597"
  }
}
resource "aws_s3_bucket" "foo" {
  ...
  tags = {
    yor_trace = "eb9e0829-e3c6-42ea-883c-525666af88a8"
  }
}
...
resource "aws_cloudtrail" "foo_cloudtrail" {
  ...
  tags = {
    yor_trace = "619e90bd-435f-43c2-b2f9-94af5595dd03"
  }
}
...
resource "aws_vpc_peering_connection" "foo" {
  ...
  tags = {
    yor_trace = "6efe4d49-e910-4c29-b1b7-d9efec8f9f52"
  }
}
resource "aws_vpc" "foo_vpc" {
  ...
  tags = {
    ...
    yor_trace = "75ef783c-bbce-4d75-a846-3340f6020638"
  }
}
resource "aws_vpc" "bar_vpc" {
  ...
  tags = {
    ...
    yor_trace = "0e534afc-0f3f-4140-ae3d-11d6f2b630fc"
  }
}
...
resource "aws_security_group" "allow_tcp" {
  ...
  tags = {
    yor_trace = "c5a10bd7-3e48-4894-8f65-d5802d8385ef"
  }
}
...
resource "aws_security_group" "allow_rdp" {
  ...
  tags = {
    yor_trace = "2f98a96a-e858-4b5e-bce2-e4a33ff25428"
  }
}
...
resource "aws_security_group" "allow_all_traffic" {
  ...
  tags = {
    yor_trace = "6e00945c-bb94-4b45-8cd1-382c596e2b51"
  }
}
...
resource "aws_security_group" "allow_udp69" {
  ...
  tags = {
    yor_trace = "1f785a9e-cbe3-4b63-935d-14a2bf2bc83e"
  }
}
...
resource "aws_network_acl" "main" {
  ...
  tags = {
    yor_trace = "0eba7204-f108-4eec-9fd7-d3429b4daed7"
  }
}
...
resource "aws_redshift_parameter_group" "bar" {
  ...
  tags = {
    yor_trace = "ae57d001-71cb-49a5-9efd-2a1bbe6285b8"
  }
}
...
resource "aws_db_instance" "default" {
  ...
  tags = {
    yor_trace = "c70f9c52-08a0-46f3-9a90-749db1137334"
  }
}
...
resource "aws_sns_topic" "default" {
  name = "rds-events"
  tags = {
    yor_trace = "b750fd0d-f49a-44ac-bf96-bad6bf8ee4a8"
  }
}
resource "aws_db_event_subscription" "default" {
  ...
  enabled = false
  tags = {
    yor_trace = "d5f615cd-dd03-4253-8869-7ccd6dd96617"
  }
}
...
resource "aws_kms_key" "a" {
  ...
  tags = {
    yor_trace = "744312a4-b51b-44e6-9002-64ffb82f1fef"
  }
}
...
resource "aws_vpc" "mainvpc" {
  ...
  tags = {
    yor_trace = "0cce7d01-e970-4168-a20d-68b720738a17"
  }
}
resource "aws_default_security_group" "default" {
  ...
  tags = {
    yor_trace = "439669c3-b2bd-4cd0-9050-f40bd6749ec5"
  }
}
...
resource "aws_ecs_task_definition" "github-backup" {
  ...
  DEFINITION
  tags = {
    yor_trace = "a383ee98-2d91-4175-a63a-ca92313bac79"
  }
}
resource "aws_ecs_task_definition" "github-backup2" {
  ...
  DEFINITION
  tags = {
    yor_trace = "9ce6be4e-fbcf-4b95-8a40-68927f9e99cf"
  }
}
...
resource "aws_elasticsearch_domain" "example" {
  ...
  tags = {
    yor_trace = "72da3ff2-0181-4501-985d-79b9538a2e1f"
  }
}
...
resource "aws_eks_cluster" "example" {
  ...
  version = "1.9.9"
  tags = {
    yor_trace = "7ba0ab75-069b-4a1f-b07d-dc318b556551"
  }
}